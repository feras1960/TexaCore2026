...
> **التاريخ:** 2026-02-11 | **الإصدار:** 2.0 Final  
> **إجمالي المراحل:** 16 مرحلة | **الجهد التقديري:** ~45-55 ساعة
...
══ الجولة 2: التبويبات الجديدة ═════════════════════════
 ...
 ⑥ المرحلة 6: سند القبض + شروط الدفع             [4-5h]
 ⑦ المرحلة 7: شحن العميل                          [2-3h]
 ⑧ المرحلة 8: القيد المحاسبي                      [2-3h]
 ⑨ المرحلة 9: 🤖 NexaAgent — ذكاء العميل          [4-6h]

══ الجولة 3: التكامل + المبيعات ════════════════════════
 ⑩ المرحلة 10: تخصيص configs                      [1-2h] ✅
 ⑪ المرحلة 11: نسخ المستند + سجل الأسعار          [2-3h] ✅
 ⑫ المرحلة 11.5: إصلاح companyId + سجل نشاط فعلي  [1h]  ✅ 2026-02-11

══ الجولة 4: التبويبات الذكية + المشتريات ══════════════ ← أنت هنا
 ⑬ المرحلة 12A: التبويبات الذكية (mode-aware)      [3-4h] � جاري
 ⑭ المرحلة 12B: تخصيص فاتورة المشتريات            [4-5h] 🟠 جاري
 ⑮ المرحلة 12C: تبويب المرفقات PDF (3MB/ملف, 20MB) [3-4h] 🔴 القادم
 ⑯ المرحلة 13: دورة المشتريات الكاملة              [5-7h] 🟡
 ⑰ المرحلة 14: تحسينات الفواتير العامة             [6-8h] 🟡
 ⑱ المرحلة 15: التقارير والتحليلات                 [8-10h] 🟢
```
...
| `trade_container` (حاوية) | الأصناف + الشحن البحري + المصاريف + المرفقات + النشاط |
