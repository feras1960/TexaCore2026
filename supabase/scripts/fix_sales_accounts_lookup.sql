-- ═══════════════════════════════════════════════════════════════
-- Fix: Update post_sales_invoice account code lookups
-- Problem: The function searches for 4100/4110 but the chart uses 411
-- Solution: Add the shorter code variants to the lookup
-- ═══════════════════════════════════════════════════════════════
