-- ══════════════════════════════════════════════════════════════════════
-- 🔧 post_sales_invoice() — V2: ترحيل بناءً على المواد المسلّمة فعلياً
-- ══════════════════════════════════════════════════════════════════════
--
-- V2 — فبراير 25, 2026:
...
--
-- المشكلة المُصلحة:
-- ❌ V1: القيد يُحسب من الفاتورة الأصلية (quantity, total_amount)
-- ✅ V2: القيد يُحسب من الكميات المسلّمة فعلياً (delivered_qty)
-- ══════════════════════════════════════════════════════════════════════
...
COMMENT ON FUNCTION post_sales_invoice IS 'ترحيل فاتورة مبيعات — V2: قيد محاسبي بناءً على الكميات المسلّمة فعلياً + COGS + حساب عميل فرعي';
