/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * DEMO DATA SEED SCRIPT - Node.js Version
 * سكريبت إنشاء البيانات التجريبية - نسخة Node.js
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 * التشغيل: node supabase/seed/run_seed.mjs
 */
...
// ═══════════════════════════════════════════════════════════════
// Get user credentials from command line or prompt
// ═══════════════════════════════════════════════════════════════
const email = process.argv[2];
const password = process.argv[3];

if (!email || !password) {
  console.log('\n📝 Usage: node supabase/seed/run_seed.mjs <email> <password>');
  console.log('   Example: node supabase/seed/run_seed.mjs user@example.com mypassword123\n');
  process.exit(1);
}
...
async function main() {
  ...
  // 1. Get Account Types
  // ═══════════════════════════════════════════════════════════════
  console.log('📊 جاري الحصول على أنواع الحسابات...');
  ...
  if (!CURRENT_ASSET) {
    ...
    console.log('Available types:', accountTypes?.map(t => t.code));
    process.exit(1);
  }
