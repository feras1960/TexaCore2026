...
echo "🎛️ Mixing Voices with Delays..."
ffmpeg -y -i /tmp/moh_bgm.mp3 -i /tmp/part1.mp3 -i /tmp/part2.mp3 -i /tmp/part3.mp3 \
       -filter_complex "
         ...
         [final]atrim=duration=45[out]
       " -map "[out]" -ar 8000 -ac 1 -acodec pcm_s16le -f wav /tmp/texacore-hold.wav 2>/dev/null

echo "✅ Generated file: /tmp/texacore-hold.wav"
ls -la /tmp/texacore-hold.wav
