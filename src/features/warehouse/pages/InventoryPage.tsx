                                                ...
                                                {isOpen && (
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                {/* Panel header */}
                                                                <div className="flex items-center gap-3 px-4 py-2.5 bg-indigo-50/80 dark:bg-indigo-950/30 border-y border-indigo-200/60 dark:border-indigo-800/40">
                                                                    ...
                                                                    <span className="text-[10px] font-mono text-indigo-500 ms-1" dir="ltr">
                                                                        {mat.material_code}
                                                                    </span>
                                                                    <Badge variant="secondary" className="text-[10px] h-5 bg-indigo-100/80 text-indigo-600 dark:bg-indigo-900/50 dark:text-indigo-400 font-mono ms-1" dir="ltr">
                                                                        {fmt(mat.total_meters)} {t('inventory.meterUnit')} | {fmt0(mat.total_rolls)} {t('inventory.rolls')}
                                                                    </Badge>
                                                                    <button
                                                                        className="ms-auto w-6 h-6 rounded-md flex items-center justify-center text-gray-400 hover:text-gray-600 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
                                                                ...
                                                                <div className="bg-white dark:bg-gray-900 max-h-[420px] overflow-y-auto">
