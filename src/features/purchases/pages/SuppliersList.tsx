                    ...
                    <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full sm:w-auto" dir={direction}>
                        <TabsList className="bg-muted/50 p-1 rounded-lg inline-flex w-full sm:w-max overflow-x-auto">
                            <TabsTrigger value="all" className="data-[state=active]:bg-white data-[state=active]:shadow-sm text-xs px-3 h-8 font-tajawal">
                                {isRTL ? 'الكل' : 'All'}
                                <Badge variant="secondary" className="ms-1.5 text-[10px] px-1.5 py-0 h-4 bg-gray-200/60 dark:bg-gray-700">{suppliers.length}</Badge>
                            </TabsTrigger>
                            <TabsTrigger value="active" className="data-[state=active]:bg-white data-[state=active]:shadow-sm text-xs px-3 h-8 text-emerald-600 font-tajawal">
                                {isRTL ? 'نشط' : 'Active'}
                                <Badge variant="secondary" className="ms-1.5 text-[10px] px-1.5 py-0 h-4 bg-emerald-100/60 text-emerald-700 dark:bg-emerald-900/20">{suppliers.filter(s => s.status === 'active').length}</Badge>
                            </TabsTrigger>
                            <TabsTrigger value="inactive" className="data-[state=active]:bg-white data-[state=active]:shadow-sm text-xs px-3 h-8 text-gray-500 font-tajawal">
                                ...
                                <Badge variant="secondary" className="ms-1.5 text-[10px] px-1.5 py-0 h-4 bg-gray-200/60 dark:bg-gray-700">{suppliers.filter(s => s.status !== 'active').length}</Badge>
                            </TabsTrigger>
                        </TabsList>
                    </Tabs>
