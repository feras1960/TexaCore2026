          ...
          <div className="w-full max-w-md">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <Button
                type="button"
                variant="outline"
                className="h-11 text-sm font-medium gap-2 border-gray-200 hover:bg-gray-50 transition-all"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  />
                  <User className="absolute top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 end-3" />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-11 border-gray-200 focus:border-teal-500 focus:ring-teal-500/20 pe-10"
                  />
                  <Building2 className="absolute top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 end-3" />
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-11 border-gray-200 focus:border-teal-500 focus:ring-teal-500/20 pe-10"
                  />
                  <Phone className="absolute top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400 end-3" />
                </div>
              </div>
