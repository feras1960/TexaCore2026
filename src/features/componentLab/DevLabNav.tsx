...
import {
    TestTube, Sheet, Eye, Database, Layers, Grid3X3, BarChart3
} from 'lucide-react';
...
const LAB_TABS = [
    ...
    {
        id: 'charts',
        route: '/dev/charts-lab',
        labelAr: 'المخططات البيانية',
        labelEn: 'Charts Lab',
        icon: BarChart3,
        bgActive: 'bg-rose-50 border-rose-500 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300 dark:border-rose-400',
        badge: 'NEW',
    },
];
