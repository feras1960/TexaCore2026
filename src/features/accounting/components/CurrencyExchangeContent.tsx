...
interface CurrencyExchangeContentProps {
  isActive: boolean;
...
export default function CurrencyExchangeContent({ 
  isActive,
  fund,
  ...
  }, [isActive, fund, initialFromCurrency, initialToCurrency]);
      ...
      <ScrollArea className="flex-1">
        <div className="p-6 space-y-6">
                ...
                {fund.balances.filter(b => b.balance > 0).map(balance => (
                  ...
                  >
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="font-mono font-bold text-sm" dir="ltr">{formatNumber(balance.balance)}</span>
          ...
          <div className="flex items-center gap-4">
            {/* From Currency */}
            <Card className={cn('flex-1', isOverBalance ? 'border-red-300 bg-red-50' : 'border-gray-200')}>
              <CardContent className="p-4">
                ...
                >
                  <SelectTrigger className="bg-white mb-2 h-10">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                ...
                {fromBalance && (
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={cn('font-mono font-bold', isOverBalance ? 'text-red-600' : 'text-gray-900')} dir="ltr">
                      {formatNumber(fromBalance.balance)} {formData.fromCurrency}
                    </span>
                  </div>
                )}
              </CardContent>
                ...
                {toBalance ? (
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-mono text-gray-900" dir="ltr">
                      {formatNumber(toBalance.balance)} {formData.toCurrency}
                    </span>
                  </div>
                ) : (
              ...
              <CardContent className="p-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                    ...
                    <span className="font-mono font-bold text-red-600" dir="ltr">
                      -{formatNumber(amount)} {formData.fromCurrency}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center justify-between p-3 bg-white rounded-lg">
                    ...
                    <span className="font-mono font-bold text-green-600" dir="ltr">
                      +{resultAmount.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} {formData.toCurrency}
                    </span>
                  </div>
