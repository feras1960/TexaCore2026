        ...
        try {
            ...
            const sampleData = {
                ...
                entry: {
                    ...
                    lines: [
                        { account_code: '1131', account_name: isAr ? 'ذمم مدينة' : 'Accounts Receivable', name_ar: 'ذمم مدينة', name_en: 'Accounts Receivable', debit: 5462.50, credit: 0 },
                        { account_code: '411', account_name: isAr ? 'المبيعات' : 'Sales', name_ar: 'المبيعات', name_en: 'Sales', debit: 0, credit: 5000 },
                        { account_code: '214', account_name: isAr ? 'ضريبة مستحقة' : 'VAT Payable', name_ar: 'ضريبة مستحقة', name_en: 'VAT Payable', debit: 0, credit: 462.50 },
                    ]
                },
