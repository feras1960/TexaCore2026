        ...
        <div id="nexa-copilot-root">
            ...
            {!isOpen && (
                <button
                    ...
                    className={`fixed bottom-24 z-[9999] w-12 h-12 rounded-full bg-gradient-to-br from-indigo-600 to-purple-600 text-white shadow-lg hover:shadow-xl transition-all hover:scale-110 flex items-center justify-center group ${isAr ? 'left-8' : 'right-8'}`}
                    title={isAr ? 'وكيل نيكسا برو' : 'NexaPro Agent'}
                >
